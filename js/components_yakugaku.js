...
<div v-if="subCategory==='yakugaku'" style="display:flex;flex-wrap:wrap;gap:4px;margin-bottom:12px">
    ...
    <div v-if="sub==='yg_fukuyaku'">
      <div class="section">
        ...
        <div style="font-size:12px;line-height:1.8">
          <div style="font-weight:700;margin-bottom:6px">1. 概要</div>
          <div style="color:var(--text-muted);margin-bottom:8px;padding:8px 10px;background:var(--surface2);border-radius:6px">かかりつけ薬剤師指導料（76点）・包括管理料（291点）を廃止し、服薬管理指導料に1イ/2イ（かかりつけ薬剤師）区分を新設。在宅オンライン薬剤管理指導料も4ロ・4ハに統合。</div>
          <div style="font-weight:700;margin-bottom:6px">2. 対象患者</div>
          ...
          <div style="font-weight:700;margin-bottom:6px">5. 改定内容・狙い</div>
          <div style="color:var(--text-muted);margin-bottom:8px">かかりつけ薬剤師指導料（76点）・包括管理料（291点）を廃止し、服薬管理指導料にかかりつけ薬剤師区分（1イ/2イ）を新設。在宅オンライン薬剤管理指導料を4ロ・4ハに統合。連携薬剤師特例（注14・59点）も廃止。</div>
          <div style="font-weight:700;margin-bottom:6px">6. 通知・疑義解釈</div>

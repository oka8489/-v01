...
const R8_BASIC_FEES = [
  ...
  },
  {
    ...
    changeType: 'modified',
    countHint: '【R8予測式】R7調剤基本料件数 + R7かかりつけ薬剤師包括管理料件数。かかりつけ薬剤師包括管理料（291点）はR8で廃止され、調剤基本料が別途算定されるため件数が増加。',
    r8: { options: [
...
const R8_PREPARATION_FEES = [
  {
    ...
    countHint: '【R8予測式】R7内服件数 + R7かかりつけ薬剤師包括管理料件数。かかりつけ薬剤師包括管理料（291点）はR8で廃止され、薬剤調製料が別途算定されるため内服として件数が増加。',
    r8: { fixedPoints: 24 },
  },
  {
...
const R8_MANAGEMENT_FEES = [
  {
    ...
    changeType: 'modified', hideAmount: true,
    countHint: '【R8予測式】R7調剤管理料（内服）件数 + R7かかりつけ薬剤師包括管理料件数。かかりつけ薬剤師包括管理料（291点）はR8で廃止され、調剤管理料が別途算定されるため件数が増加。',
    r8: {},
  },
  {
  ...
  },
  {
    ...
    changeType: 'abolished_merged',
    changeNote: 'R8で廃止（R6: 40点）。薬学的有害事象等防止加算（ニ30点/イロハ50点）に再編。在宅患者重複投薬・相互作用等防止管理料（残薬以外40点）も同時に廃止。',
    r8: null,
  },
  {
    id: 't_yugai', label: '薬学的有害事象等防止加算', category: 'management', inputType: 'count-only', isSub: true,
    changeType: 'new', isGroupHeader: true,
    changeNote: 'R8新設。旧「重複防止加算（残薬以外）40点」と「在宅患者重複投薬・相互作用等防止管理料（残薬以外）40点」を廃止し、重複投薬・相互作用等の防止に特化した加算として再編。ニ30点（R6の40点から減点）、イロハ50点（在宅・かかりつけ薬剤師は増点）。',
    r8: {},
  },
  {
    id: 't_yugai1', label: 'ニ（その他）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new', needsDb: true,
    countHint: '処方内容の疑義照会により処方変更があった回数（残薬調整を除く）。重複投薬・相互作用等の薬学的有害事象の防止に係る介入が対象。R6の40点から30点に減点。【R8予測式】R7重複防止加算（残薬以外）− 同 × かかりつけ比率',
    r8: { fixedPoints: 30 },
  },
  {
    id: 't_yugai2', label: 'イロハ（在宅又はかかりつけ）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new', needsDb: true,
    countHint: '在宅患者へ処方前に処方医に相談（イ50点）、在宅患者（ロ50点）、かかりつけ薬剤師（ハ50点）。R6の40点から50点に増点。【R8予測式】R7在宅重複投薬管理料（残薬以外）+ R7重複防止加算（残薬以外）× かかりつけ比率',
    r8: { fixedPoints: 50 },
  },
  {
    id: 't_jufuku_zan', label: '重複防止加算（残薬）', category: 'management', inputType: 'fixed', isSub: true,
    changeType: 'abolished_merged',
    changeNote: 'R8で廃止（R6: 20点）。調剤時残薬調整加算（ニ30点/イロハ50点）に再編。在宅患者重複投薬・相互作用等防止管理料（残薬20点）も同時に廃止。',
    r8: null,
  },
  {
    id: 't_zanyaku', label: '調剤時残薬調整加算', category: 'management', inputType: 'count-only', isSub: true,
    changeType: 'new', isGroupHeader: true,
    changeNote: 'R8新設。旧「重複防止加算（残薬）20点」と「在宅患者重複投薬・相互作用等防止管理料（残薬）20点」を廃止し、残薬調整に特化した加算として再編。ニ30点（増点）、イロハ50点（在宅・かかりつけ薬剤師は大幅増点）。処方箋様式に残薬確認時の減数調剤指示欄を追加。',
    r8: {},
  },
  {
    id: 't_zanyaku1', label: 'ニ（その他）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new', needsDb: true,
    countHint: '残薬確認後、処方医の指示に基づき7日分以上の調剤日数変更が行われた回数。R6の20点から30点に増点。【R8予測式】R7重複防止加算（残薬）− 同 × かかりつけ比率',
    r8: { fixedPoints: 30 },
  },
  {
    id: 't_zanyaku2', label: 'イロハ（在宅又はかかりつけ）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new', needsDb: true,
    countHint: '在宅患者へ処方前に処方医に相談（イ50点）、在宅患者（ロ50点）、かかりつけ薬剤師（ハ50点）。R6の20点から50点に大幅増点。【R8予測式】R7在宅重複投薬管理料（残薬）+ R7重複防止加算（残薬）× かかりつけ比率',
    r8: { fixedPoints: 50 },
  },
  {
  ...
  },
  {
    ...
    changeType: 'modified', isGroupHeader: true,
    changeNote: 'R8でかかりつけ薬剤師区分（1イ/1ロ）を新設。かかりつけ薬剤師指導料（76点）・包括管理料（291点）の廃止に伴う再編。点数45点は据置。',
    r8: { fixedPoints: 45 },
  },
  {
    id: 't_fukuyaku_a_i', label: '1イ かかりつけ薬剤師', category: 'management', inputType: 'select', isDetail: true,
    changeType: 'new', goToJudgeId: 'yg_fukuyaku',
    changeNote: 'R8新設。かかりつけ薬剤師指導料（76点）の廃止に伴い、服薬管理指導料にかかりつけ薬剤師区分を新設。45点。施設基準の届出（様式90）が必要。',
    countHint: '【R8予測式】（R7かかりつけ薬剤師指導料 + R7かかりつけ薬剤師包括管理料）× 手帳持参率',
    r8: { options: [{ value: 45, label: '算定する（45点）' }, { value: 0, label: '算定しない' }] },
  },
  {
    id: 't_fukuyaku_a_ro', label: '1ロ その他', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new',
    changeNote: 'R8新設。かかりつけ薬剤師以外が指導した場合。R6の服薬管理指導料1と同額の45点。',
    countHint: '【R8予測式】R7服薬管理指導料1 + R7連携薬剤師特例 × 手帳持参率',
    r8: { fixedPoints: 45 },
  },
  {
  ...
  {
    id: 't_fukuyaku_c_i', label: '2イ かかりつけ薬剤師', category: 'management', inputType: 'select', isDetail: true,
    changeType: 'new', goToJudgeId: 'yg_fukuyaku',
    changeNote: 'R8新設。かかりつけ薬剤師指導料（76点）の廃止に伴い、服薬管理指導料にかかりつけ薬剤師区分を新設。59点。施設基準の届出（様式90）が必要。',
    countHint: '【R8予測式】（R7かかりつけ薬剤師指導料 + R7かかりつけ薬剤師包括管理料）×（1 − 手帳持参率）',
    r8: { options: [{ value: 59, label: '算定する（59点）' }, { value: 0, label: '算定しない' }] },
  },
  {
    id: 't_fukuyaku_c_ro', label: '2ロ その他', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new',
    changeNote: 'R8新設。かかりつけ薬剤師以外が指導した場合。R6の服薬管理指導料2と同額の59点。',
    countHint: '【R8予測式】R7服薬管理指導料2（手帳なし+3月超）+ R7連携薬剤師特例 ×（1 − 手帳持参率）',
    r8: { fixedPoints: 59 },
  },
  {
    id: 't_fukuyaku_3', label: '服薬管理指導料3（介護施設入所者）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    changeNote: '点数45点は据置。R6から変更なし。',
    r8: { fixedPoints: 45 },
  },
  {
    id: 't_fukuyaku_online', label: '服薬管理指導料4（情報通信機器）', category: 'management', inputType: 'count-only',
    changeType: 'modified', isGroupHeader: true,
    changeNote: 'R6の4イ/4ロの2区分→R8で4イ/4ロ/4ハ/4ニの4区分に拡大。在宅患者オンライン薬剤管理指導料（4ロ）・在宅患者緊急オンライン薬剤管理指導料（4ハ）を統合。',
  ...
  },
  {
    ...
    changeType: 'same',
    changeNote: 'R6の4イと同じ。45点据置。',
    countHint: '【R8予測式】R7服薬管理指導料4イ（3月以内）をそのまま引継ぎ',
    r8: { fixedPoints: 45 },
  },
  {
    id: 't_fukuyaku_online_ro', label: '4ロ 在宅（通院困難）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new',
    changeNote: 'R8新設。旧「在宅患者オンライン薬剤管理指導料」（59点）を服薬管理指導料4ロに統合。',
    countHint: '【R8予測式】R7在宅患者オンライン薬剤管理指導料をそのまま引継ぎ',
    r8: { fixedPoints: 59 },
  },
  {
    id: 't_fukuyaku_online_ha', label: '4ハ 在宅（急変等）', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'new',
    changeNote: 'R8新設。旧「在宅患者緊急オンライン薬剤管理指導料」（59点）を服薬管理指導料4ハに統合。',
    countHint: '【R8予測式】R7在宅患者緊急オンライン薬剤管理指導料をそのまま引継ぎ',
    r8: { fixedPoints: 59 },
  },
  {
    id: 't_fukuyaku_online_ni', label: '4ニ その他', category: 'management', inputType: 'fixed', isDetail: true,
    changeType: 'same',
    changeNote: 'R6の4ロ（4イ以外・59点）に相当。点数据置。',
    countHint: '【R8予測式】R7服薬管理指導料4ロ（4イ以外）をそのまま引継ぎ',
    r8: { fixedPoints: 59 },
  },
  {

...
const MANAGEMENT_FEES = [
  ...
  {
    id: 't_fukuyaku_a', label: '服薬管理指導料（薬A）手帳あり3月以内', category: 'management', inputType: 'fixed',
  ...
  {
    id: 't_fukuyaku_b', label: '服薬管理指導料（薬B）手帳なし3月以内', category: 'management', inputType: 'fixed',
  ...
  {
    id: 't_fukuyaku_c', label: '服薬管理指導料（薬C）3月以外', category: 'management', inputType: 'fixed',
  ...
  {
    id: 't_fukuyaku_3', label: '服薬管理指導料（薬3）特養入居者', category: 'management', inputType: 'fixed',

  ...
  setup(props, { emit }) {
    ...
    const c2FacilityChecks = [
      { group: '（２）地域における医薬品等の供給拠点としての対応', items: [
        { key: 'f2a', label: '（２）ア 十分な数の医薬品の備蓄、周知（医療用医薬品1200品目）', help: '<b>必要な対応:</b>\n・医療用医薬品を<b>1,200品目以上</b>備蓄\n・備蓄品目リストの作成・更新\n・地域の医療機関等へ備蓄品目を周知' },
        { key: 'f2b', label: '（２）イ 薬局間連携による医薬品の融通等', help: '<b>必要な対応:</b>\n・近隣薬局との医薬品融通ネットワークへの参加\n・融通実績の記録（別紙様式4-1）\n・加算1の(2)と共通' },
        { key: 'f2c', label: '（２）ウ 医療材料及び衛生材料を供給できる体制', help: '<b>必要な対応:</b>\n・在宅患者向けの医療材料・衛生材料を取り扱える体制\n・注射器、ガーゼ、カテーテル等の供給ルートの確保' },
        { key: 'f2d', label: '（２）エ 麻薬小売業者の免許', help: '<b>必要な対応:</b>\n・都道府県知事からの<b style="color:var(--r6)">麻薬小売業者免許</b>の取得\n・免許の有効期限の管理\n・麻薬管理者の届出' },
        { key: 'f2e', label: '（２）オ 取り扱う医薬品に係る情報提供体制', help: '<b>必要な対応:</b>\n・取り扱い医薬品の情報を地域の医療機関等に提供する体制\n・ホームページ等での情報公開' },
        { key: 'f2f', label: '（２）カ 調剤室の面積が16平方メートル以上（R8.6以降に開設・改築・増築する場合のみ）', isNew: true, help: '<b style="color:var(--r6)">【新規要件】</b>\n・R8年6月以降に<b>新規開設・改築・増築</b>する場合のみ適用\n・既存薬局はR8.5.31以前の状態であれば対象外\n・調剤室の面積が16㎡以上であること' },
      ]},
      { group: '（３）休日、夜間を含む薬局における調剤・相談応需体制', items: [
        { key: 'f3a', label: '（３）ア 一定時間以上の開局', help: '<b>必要な対応:</b>\n・平日は8時間以上、土曜日は一定時間の開局\n・開局時間の掲示' },
        { key: 'f3b', label: '（３）イ 休日、夜間の開局時間外の調剤・在宅業務に対応できる体制', help: '<b>必要な対応:</b>\n・開局時間外の連絡先（携帯電話等）を患者に周知\n・輪番制への参加や在宅協力薬局との連携' },
        { key: 'f3c', label: '（３）ウ 当該薬局を利用する患者からの相談応需体制', help: '<b>必要な対応:</b>\n・患者からの電話相談に対応できる体制\n・相談記録の保存' },
        { key: 'f3d', label: '（３）エ 夜間・休日の調剤、在宅対応体制（地域の輪番体制含む）の周知', help: '<b>必要な対応:</b>\n・夜間・休日対応について<b>薬局内・外への掲示</b>\n・地域の輪番体制がある場合はその旨の周知\n・ホームページ等での情報公開' },
      ]},
      { group: '（４）在宅医療を行うための関係者との連携体制等の対応', items: [
        { key: 'f4a', label: '（４）ア 診療所又は病院及び訪問看護ステーションと円滑な連携', help: '<b>必要な対応:</b>\n・近隣の医療機関・訪問看護ステーションとの連絡体制\n・退院時カンファレンス等への参加実績' },
        { key: 'f4b', label: '（４）イ 保健医療・福祉サービス担当者との連携体制', help: '<b>必要な対応:</b>\n・ケアマネジャー、訪問介護等との連携\n・サービス担当者会議への参加' },
        { key: 'f4c', label: '（４）ウ 在宅薬剤管理の実績 24回以上', help: '<b>必要な対応:</b>\n・在宅患者訪問薬剤管理指導料の年間算定回数が<b>24回以上</b>\n・介護保険の居宅療養管理指導費も含む\n・<b>薬局当たり</b>の年間の回数' },
        { key: 'f4d', label: '（４）エ 在宅に係る研修の実施', help: '<b>必要な対応:</b>\n・在宅医療に関する研修の受講・実施\n・認知症、緩和医療、ターミナルケア等に関する研修\n・研修記録の保存' },
      ]},
      { group: '（５）医療安全に関する取組の実施', items: [
        { key: 'f5a', label: '（５）ア プレアボイド事例の把握・収集', help: '<b>必要な対応:</b>\n・プレアボイド（未然防止・重篤化回避）事例の記録・収集\n・日本薬剤師会のプレアボイド報告への参加が望ましい' },
      ...
      { group: '（１１）地域医療に関連する取組の実施', items: [
        ...
        { key: 'f11g', label: '（１１）キ 薬事未承認の研究用試薬・検査サービスを提供していないこと', isNew: true, help: '<b style="color:var(--r6)">【新規要件】</b>\n・薬事承認されていない研究用試薬や検査キットを患者に提供していないこと\n・遺伝子検査サービス等、薬事未承認の検査サービスを提供していないこと' },
      ]},
    ]

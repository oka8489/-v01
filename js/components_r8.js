...
function r8CalcCategoryTotal(data, items) {
  ...
  for (const item of items) {
    ...
    else total += r8CalcGetCount(data, item) * r8CalcGetPoints(data, item) * POINT_TO_YEN
  }
...
const R8PreparationFeeSection = {
  ...
  setup(props) {
    ...
    return{mainItems,zairyoItem,kazanRows,kazanCols,unitLabels,getRaw,getVal,setVal,isFieldMissing,getPoints,getAmount,kazanRowTotal,kazanColTotal,kazanGrandTotal,totals,formatYen}
  },

...
export const BASIC_FEES = [
  {
    ...
    changeType: 'modified', changeNote: '基本料1: 45→47点。集中率厳格化、都市部新規開設薬局区分新設。',
    r6: { options: [
  ...
  {
    id: 'chiiki', label: '地域支援・医薬品供給対応体制加算', category: 'basic', inputType: 'select',
    changeType: 'merged', changeNote: '地域支援体制加算と後発品加算を統合。全区分再編。',
    r6: { label: '地域支援体制加算', options: [
      { value: 0, label: '算定なし' },
  ...
  {
    id: 'kouhatsu', label: '後発医薬品調剤体制加算', category: 'basic', inputType: 'select',
  ...
  {
    id: 'renkei', label: '連携強化加算', category: 'basic', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 5 },
    r8: { fixedPoints: 5 },
  },
  {
    id: 'dx8', label: '電子的調剤情報連携体制整備加算（高）', category: 'basic', inputType: 'fixed',
    changeType: 'modified', changeNote: '旧・医療DX推進体制整備加算から名称変更・要件変更。',
    r6: { fixedPoints: 8, label: '医療DX推進体制整備加算（8点）' },
    r8: { fixedPoints: 7 },
  },
  {
    id: 'dx10', label: '電子的調剤情報連携体制整備加算（低）', category: 'basic', inputType: 'fixed',
    changeType: 'modified',
    r6: { fixedPoints: 10, label: '医療情報取得加算（10点）' },
    r8: { fixedPoints: 6 },
  },
  {
    id: 'zaitaku_taisei', label: '在宅薬学総合体制加算', category: 'basic', inputType: 'select',
  ...
  {
    id: 'yakan', label: '夜間・休日等加算', category: 'basic', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 40 },
    r8: { fixedPoints: 40 },
  },
  ...
  {
    id: 'bio', label: 'バイオ後続品調剤体制加算', category: 'basic', inputType: 'fixed',
...
export const PREPARATION_FEES = [
  ...
  {
    id: 'naiteki', label: '内服用滴剤', category: 'preparation', inputType: 'fixed',
    unit: '1調剤につき',
    changeType: 'same',
    r6: { fixedPoints: 10 },
    r8: { fixedPoints: 10 },
...
export const MANAGEMENT_FEES = [
  {
    id: 'kanri_27', label: '調剤管理料（27日以下）', category: 'management', inputType: 'fixed',
    changeType: 'modified', changeNote: 'R6の4区分（4/28/50/60）→R8は2区分（10/60）に統合。',
    r6: { fixedPoints: 4, label: '調剤管理料（7日以下・4点）' },
    r8: { fixedPoints: 10 },
  },
  {
    id: 'kanri_28', label: '調剤管理料（28日以上）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 60 },
    r8: { fixedPoints: 60 },
  },
  ...
  {
    id: 'fukuyaku_1i', label: '服薬管理指導料 1イ（かかりつけ）', category: 'management', inputType: 'fixed',
    changeType: 'modified', changeNote: 'R6の薬A/薬B→R8は1イ/1ロ/2イ/2ロ/3に再編。かかりつけ薬剤師指導料を統合。',
    r6: { fixedPoints: 45, label: '薬剤服用歴管理指導料A（45点）' },
    r8: { fixedPoints: 45 },
  },
  {
    id: 'fukuyaku_1ro', label: '服薬管理指導料 1ロ（その他）', category: 'management', inputType: 'fixed',
    changeType: 'modified',
    r6: { fixedPoints: 45, label: '薬剤服用歴管理指導料A（45点）' },
    r8: { fixedPoints: 45 },
  },
  {
    id: 'fukuyaku_2i', label: '服薬管理指導料 2イ（かかりつけ）', category: 'management', inputType: 'fixed',
    changeType: 'modified',
    r6: { fixedPoints: 59, label: '薬剤服用歴管理指導料B（59点）' },
    r8: { fixedPoints: 59 },
  },
  {
    id: 'fukuyaku_2ro', label: '服薬管理指導料 2ロ（その他）', category: 'management', inputType: 'fixed',
    changeType: 'modified',
    r6: { fixedPoints: 59, label: '薬剤服用歴管理指導料B（59点）' },
    r8: { fixedPoints: 59 },
  },
  {
    id: 'fukuyaku_3', label: '服薬管理指導料 3（施設入所者）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 45 },
    r8: { fixedPoints: 45 },
  },
  {
    id: 'mayaku_kanri', label: '麻薬管理指導加算', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 22 },
    r8: { fixedPoints: 22 },
  },
  {
    id: 'tokutei_1i', label: '特定薬剤管理指導加算1イ（ハイリスク新規）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 10 },
    r8: { fixedPoints: 10 },
  },
  {
    id: 'tokutei_1ro', label: '特定薬剤管理指導加算1ロ（変更時）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 5 },
    r8: { fixedPoints: 5 },
  },
  {
    id: 'tokutei_2', label: '特定薬剤管理指導加算2（抗悪性腫瘍）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 100 },
    r8: { fixedPoints: 100 },
  },
  {
    id: 'tokutei_3i', label: '特定薬剤管理指導加算3イ（RMP）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 5 },
    r8: { fixedPoints: 5 },
  },
  {
    id: 'tokutei_3ro', label: '特定薬剤管理指導加算3ロ（選定療養等）', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 10 },
    r8: { fixedPoints: 10 },
  },
  {
    id: 'nyuyoji', label: '乳幼児服薬指導加算', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 12 },
    r8: { fixedPoints: 12 },
  },
  {
    id: 'shoni', label: '小児特定加算', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 350 },
    r8: { fixedPoints: 350 },
  },
  {
    id: 'kyunyu', label: '吸入薬指導加算', category: 'management', inputType: 'fixed',
  ...
  {
    id: 'joho_1', label: '服薬情報等提供料1', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 30 },
    r8: { fixedPoints: 30 },
  },
  {
    id: 'joho_2', label: '服薬情報等提供料2', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 20 },
    r8: { fixedPoints: 20 },
  },
  {
    id: 'joho_3', label: '服薬情報等提供料3', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 50 },
    r8: { fixedPoints: 50 },
  },
  {
    id: 'gairai_1', label: '外来服薬支援料1', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 185 },
    r8: { fixedPoints: 185 },
  },
  {
    id: 'shisetsu_renkei', label: '施設連携加算', category: 'management', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 50 },
    r8: { fixedPoints: 50 },
  },
  ...
  {
    id: 'iryo_joho', label: '医療情報取得加算', category: 'management', inputType: 'fixed',
    changeType: 'abolished', changeNote: '電子的調剤情報連携体制整備加算に統合。',
    r6: { fixedPoints: 3 },
    r8: null,
  },
  {
    id: 'jufuku', label: '重複投薬・相互作用等防止加算', category: 'management', inputType: 'select',
    changeType: 'abolished', changeNote: '残薬調整加算・有害事象防止加算に再編。',
    r6: { options: [
      { value: 40, label: '残薬調整（40点）' },
      { value: 30, label: 'その他（30点）' },
    ]},
    r8: null,
  },
  // R8 新設（管理料）
...
export const HOMECARE_FEES = [
  ...
  {
    id: 'zaitaku_mayaku', label: '麻薬管理加算（在宅）', category: 'homecare', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 100 },
    r8: { fixedPoints: 100 },
  },
  {
    id: 'zaitaku_mayaku_chu', label: '医療用麻薬持続注射療法加算', category: 'homecare', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 250 },
    r8: { fixedPoints: 250 },
  },
  {
    id: 'zaitaku_chushin', label: '在宅中心静脈栄養法加算', category: 'homecare', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 150 },
    r8: { fixedPoints: 150 },
  },
  {
    id: 'zaitaku_nyuyoji', label: '乳幼児加算（在宅）', category: 'homecare', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 100 },
    r8: { fixedPoints: 100 },
  },
  {
    id: 'zaitaku_shoni', label: '小児特定加算（在宅）', category: 'homecare', inputType: 'fixed',
    changeType: 'same',
    r6: { fixedPoints: 350 },
    r8: { fixedPoints: 350 },
  },
  ...
  {
    id: 'kyujitsu_homon', label: '休日訪問加算', category: 'homecare', inputType: 'count-only',
    changeType: 'same',
    r6: { fixedPoints: 0 },
    r8: { fixedPoints: 0 },
  },
  {
    id: 'shinya_homon', label: '深夜訪問加算', category: 'homecare', inputType: 'count-only',
    changeType: 'same',
    r6: { fixedPoints: 0 },
    r8: { fixedPoints: 0 },
  },
  {
    id: 'yakan_homon', label: '夜間訪問加算', category: 'homecare', inputType: 'count-only',
    changeType: 'same',
    r6: { fixedPoints: 0 },
    r8: { fixedPoints: 0 },
  },
